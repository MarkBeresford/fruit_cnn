...
def train_model():
    ...
    with tf.Session() as sess:
        ...
        writer = tf.summary.FileWriter(os.path.join(PROJECT_ROOT, 'tmp/summary', SESSION_NUM))
        ...
        for batch in range(total_train_batches):
            ...
            batch_file_paths, batch_labels = get_pixels_and_labels(training_file_paths, training_labels, batch, BATCH_SIZE)
